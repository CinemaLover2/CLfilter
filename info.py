...
# Bot information
SESSION = environ.get('SESSION', 'DHPmovieBot')
API_ID = int(environ.get('API_ID', '22130467'))
API_HASH = environ.get('API_HASH', '92103a1d15515e22a19df6d8e2182505')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7080323355').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1004487626351'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1004394019489').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003536197988') # give your force subscribe channel id here else leave it blank
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '1 month') # time in week, day, month.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/edufluxion')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/devomfilmyverse')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Deba@2006')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", f"{script.CUSTOM_FILE_CAPTION}").replace("@VJ_Bots", "")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION).replace("@VJ_Bots", "")
